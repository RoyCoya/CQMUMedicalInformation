"""
Django settings for CQMUMedicalInformation project.
...
ALLOWED_HOSTS = ['localhost','127.0.0.1','0.0.0.0','192.168.8.127','172.18.37.103','26.171.34.214','192.168.1.102', '192.168.8.152','172.32.188.136']
...
ROOT_URLCONF = 'CQMUMedicalInformation.urls'
...
WSGI_APPLICATION = 'CQMUMedicalInformation.wsgi.application'
